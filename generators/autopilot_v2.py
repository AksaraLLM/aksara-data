...
Run: nohup python3 aksarallm_autopilot_v2.py > ~/autopilot.log 2>&1 &
"""
...
class Config:
    ...
    TARGET_SFT = 500_000
    TARGET_DPO = 200_000
    CACHE_DIR = os.path.expanduser("~/autopilot_cache")
    STATE_FILE = os.path.expanduser("~/autopilot_state.pkl")
